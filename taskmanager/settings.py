...
"""
Main Django settings for the Task Manager project.
...
SECRET_KEY = 'django-insecure-jbxp#^4w1w*g2+548dr6bqdrmf%(v=_(+rdjfdt1wfg^h!@rjf'
...
STATIC_URL = '/static/'
# Collect static files here for production (e.g., with WhiteNoise)
